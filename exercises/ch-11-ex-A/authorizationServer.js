...
var protectedresourceRsaKey = {
  "kty": "RSA",
  "e": "AQAB",
  "use": "sig",
  "kid": "protectedresource",
  "alg": "RS256",
  "n": "p6iyRZMzQLoGNloQCYKMRnTl94kwgx0VYCg5f5BeJliqoIp19JewXNYDmfp4IDM74OU7h4V2PG4insPdNJUgZs4e6dzUkuaDc_ga3s_pTqRlTjFTUnJ-TsfvzD3DVvaY7GhLyqUgbojBhHo-jFQa4CqkvXzr1FLuQoFTLOuusRULjRgpxpgaTaZfq83-W2BA7jM2sgGsMbopXnej5RiH3fkTpHZsfNSZpbn5dqW275iJiUGGzySlWC61tsdKsNIIwfhn-FRSLsMFixTpeOeZ1zBr2Hdjmj2R89CGe1m5BavcA8Wu_cMYtsuLn0-6xRTUzxBlS-d4BV1uxjSlIZElqQ"
};
	...
	if (req.body.grant_type == 'authorization_code') {
		...
		if (code) {
			...
			if (code.request.client_id == clientId) {
				...
				var header = { 'typ': 'JWT', 'alg': authserverRsaKey.alg, 'kid': authserverRsaKey.kid };
				var payload = {
        ...
        var signed;
        jose.JWS.createSign({compact: true, protect: "*"}, authserverRsaKey)
        ...
        var authPrivateKey = jose.KEYUTIL.getKey(authserverRsaKey);
        var signed_access_token = jose.jws.JWS.sign(header.alg,
          JSON.stringify(header),
          JSON.stringify(payload),
          authPrivateKey);
          
        console.log(signed_access_token);
        
        var resourcePublicKey = jose.KEYUTIL.getKey(protectedresourceRsaKey);
        var encrypted_access_token = jose.KJUR.crypto.Cipher.encrypt(signed_access_token, resourcePublicKey, protectedresourceRsaKey.kty);
